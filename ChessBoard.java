public class ChessBoard {
    ...
    public ChessBoard() {
        squares[0][0] = new Square("A", 8, null);
        ...
        squares[7][0] = new Square("H", 8, null);
        ...
        squares[0][7] = new Square("A", 1, null);
        ...
        squares[7][7] = new Square("H", 1, null);
    }
    ...
    public void setPiece(Piece piec, Square target){
        String col = target.getColumn();
        int row = target.getRow();
        //int color = piec.getColor();
        //String rank = piec.getRank();
